...
pub fn router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/admin/import-templates", get(admin::list_import_templates))
        .route("/admin/import-templates/:template_key", post(admin::update_import_template))
        .route("/admin/export-templates/:template_key", get(admin::get_export_template))
        .route("/admin/export-templates/:template_key", post(admin::update_export_template))
